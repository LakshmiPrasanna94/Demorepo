...
<div id="container">
	<div id="header">
		New Process Instance: /simpleform/src/main/resources/org/demo.simpleform
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Process inputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="Employee" type="text" class="textbox" id="Employee" value="" />
                            		</div>
              	
                            		<label for="name">Reason</label>
                            		<div class="div_texbox">
                              		<input name="Reason" type="text" class="textbox" id="Reason" value="" />
                            		</div>
              	
                            		<label for="name">Performance</label>
                            		<div class="div_texbox">
                              		<input name="Performance" type="text" class="textbox" id="Performance" value="" />
                            		</div>
